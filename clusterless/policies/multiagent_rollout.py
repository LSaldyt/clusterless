...
def multiagent_rollout(map, sense_info, memory, base_policy, t, s, do_render=False, mask_unseen=True):
    ...
    for i, sense in enumerate(sense_info):
        given_actions[i, :] = egocentric_rollout(map, sense.memory, codes, memory,
